  ...
  <body>
   ...
   @include('home.nav')
          ...
          <div class="container" data-scrollax-parent="true">
            <div class="row slider-text align-items-end">
              <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="index.html">Home</a></span> <span>Doctors</span> <span>Bishwo</span></p>
    ...
    <div id="container">
        <div id="profile">
            <div id="image">
                <img id="profile-photo" src={{ asset('home/images/bishwo.jpg')}} alt="Profile-Image">
                <a href="#"><i class="fa fa-pen stroke-transparent"></i></a>
            </div>
            <p id="name">Dr Bishwo Prachanda Sedhain<br><span id="email">contact@gmail.com</span></p>
            <p id="designation"><span id="college">Master of Dental Surgery in
                Oral and Maxillofacial Surgery</span></p>
        ...
        <div id="info-cards">
            ...
            <div class="card">
                ...
                <ul>
                    <li class="info_doctor"> NMC no- 6551 </li>
                    <li class="info_doctor"> BDS (2006): BPKIHS Dharan  </li>
                    <li class="info_doctor">MDS (2013): HUST China ( Scholarship Ministry of Education Nepal)</li>
                    <li class="info_doctor">OMFS- Chetrapati Free Clinic</li>
                </ul>
                {{-- <a href="#">+ Add new</a> --}}
            </div>
        </div>
