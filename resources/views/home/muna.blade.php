  ...
  <body>
   ...
   @include('home.nav')
          ...
          <div class="container" data-scrollax-parent="true">
            <div class="row slider-text align-items-end">
              <div class="col-md-7 col-sm-12 ftco-animate mb-5">
                <p class="breadcrumbs" data-scrollax=" properties: { translateY: '70%', opacity: 1.6}"><span class="mr-2"><a href="index.html">Home</a></span> <span>Doctors</span> <span>Muna</span></p>
    ...
    <div id="container">
        <div id="profile">
            <div id="image">
                <img id="profile-photo" src={{ asset('home/images/muna.jpeg')}} alt="Profile-Image">
                <a href="#"><i class="fa fa-pen stroke-transparent"></i></a>
            </div>
            <p id="name">Dr Muna Kandel<br><span id="email">contact@gmail.com</span></p>
            <p id="designation"><span id="college">MS Human Anatomy</span></p>
        ...
        <div id="info-cards">
            ...
            <div class="card">
                ...
                <ul>
                    <li class="info_doctor">NMC no 7679</li>
                    <li class="info_doctor">BDS (2007): PDCH Kathmandu (Gold Medalist)</li>
                    <li class="info_doctor">MS(2012): BPKIHS</li>
                    <li class="info_doctor">Associate Professor- College of Medicine , Nepalese Army</li>
                </ul>
                {{-- <a href="#">+ Add new</a> --}}
            </div>
        </div>
